...
For a single ionic species $X$, the process is straightforward enough that I have reproduced a sketch derivation below, for the mathy types.
...
in a neuroscience context: +1, -1, or +2
