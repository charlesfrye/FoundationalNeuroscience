---
layout: post
title:	"What is Bayes' Rule? Explain how an aspect of perception can be expressed in terms of Bayes' Rule.  (See: Wolpert & Ghahramani)"
date:	2016-02-04
category:	"sensation"
---
...
In fact, since we've already seen the data, $$\mathbf{(\textrm{Hypothesis | Data})}$$
...
but want to know the 3-D shape, texture, and color of a rich scence of objects,
and we feel minute changes in air pressure inside our skulls,
but want to know if they were made by a wolf or a dog.

Bayes' rule helps us figure out which explanation is most likely,
or represent our uncertainty about which explanation is true,
*without our having epistemological access to these explanations*
(we'll leave questions of ontology to the side).
...
$$\mathbf{P}(\textrm{Roar}) = 4/100 $$

$$\mathbf{P}(\textrm{Tiger}) =  8/100 $$
...
The section of visualizing probability commits what is a fatal heresy
in the eyes of a true, red-blooded Bayesian:
it defines the probability of an event in terms of its long-run frequency.
This definition is what gave the name to school of thought
...
Extremeley interested readers can check out the first few chapters of ET Jaynes' incomplete magnum opus,
